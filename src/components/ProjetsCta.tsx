  ...
  return (
    <section className="border-t border-white/10">
      <div className="section-container py-20 md:py-28">
        ...
        >
          <p className="mb-3 text-[0.72rem] font-semibold uppercase tracking-[0.2em] text-white/80">
            Votre projet
          </p>
          <h2 className="text-[1.875rem] font-light tracking-tight text-white sm:text-[2.25rem] md:text-[2.75rem]">
            Vous avez un projet{" "}
            <span className="font-semibold">similaire ?</span>
          </h2>
          <p className="mt-4 text-[1rem] leading-[1.7] text-white/80 md:text-[1.0625rem]">
