...
import { GOOGLE_PLACE_URL, type GoogleReviews } from "@/lib/reviews";
 ...
 * `lib/reviews.ts`).
 *
 * ⚠️ **Bandes pleine largeur, et non une grille de cartes** — c'est la mise en
 * page à conserver. La première version reprenait la grille à trois colonnes du
 * reste du site : avec deux avis seulement, chaque carte tombait à ~380 px de
 * large, et celui de ThermoChrono (420 caractères) s'y étirait sur une dizaine
 * de lignes. Deux colonnes hautes et étroites, arbitré « trop vertical ».
 *
 * Ici l'identité de l'auteur tient dans une colonne fixe à gauche et la
 * citation dispose de toute la largeur restante : le même avis tient en cinq ou
 * six lignes. La longueur d'un avis cesse de piloter la hauteur de la section —
 * ce qui compte, puisqu'on ne choisit pas ce que les clients écrivent.
 */
    ...
    <section className="section-padding border-t border-[var(--border)] overflow-hidden">
      <div className="section-container min-w-0">
        ...
        >
          ...
          {/*
            La note globale porte la crédibilité de la section : sans elle, deux
            ...
            vaut attribution au sens des conditions Google.
          */}
          <a
        ...
        */}
        ...
        >
          {data.reviews.map((review) => (
            ...
            >
              {/*
                Auteur. `order` inversé sous 640 px : la citation repasse en
                premier et l'auteur revient dessous, en ligne — le format
                classique d'un témoignage, et le seul lisible quand la colonne
                de gauche n'a plus de largeur à occuper.
              */}
              ...
              <div className="order-1 flex min-w-0 flex-col gap-3 sm:order-2">
                ...
                <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-1">
                  {/*
                    ...
                    l'annonce plutôt que de la faire passer pour ses mots. Le
                    `span` vide garde le lien à droite quand il n'y en a pas.
                  */}
                  {review.translated ? (
