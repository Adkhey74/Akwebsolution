...
export const projects: CaseStudy[] = [
  ...
  },
  {
    ...
    cover: { src: "/images/Kabuki/Acceuil.png", alt: "Kabuki — page d'accueil du site" },
    images: [
  ...
  },
  {
    ...
    techs: ["Next.js", "React", "Tailwind CSS"],
    cover: { src: "/images/herntaxi/acceuil-new.png", alt: "HernTaxi — page d'accueil du site" },
    images: [
      { src: "/images/herntaxi/acceuil-new.png", alt: "HernTaxi — page d'accueil" },
      { src: "/images/herntaxi/vehicule.png", alt: "HernTaxi — les véhicules" },
      { src: "/images/herntaxi/reservations.png", alt: "HernTaxi — réservation" },
      { src: "/images/herntaxi/stationdeski.png", alt: "HernTaxi — transferts stations de ski" },
  ...
  },
  {
    ...
    techs: ["Next.js", "React", "Tailwind CSS"],
    cover: { src: "/images/thermochrono/acceuil.png", alt: "ThermoChrono — page d'accueil de la boutique" },
    images: [
      { src: "/images/thermochrono/acceuil.png", alt: "ThermoChrono — page d'accueil" },
